        ...
        <div className="chatShell">
          ...
          <div className="chatBody">
            <div className="assistantMessage">
              <strong>Welcome to Project Pilot.</strong>
              <p>Tell me about the project you're planning.</p>
            </div>
            ...
            {submitted && (
              <>
                ...
                <div className="assistantMessage">
                  ...
                  <p>
                    What is the full property address for this project? I'll use it
                    to identify the likely jurisdiction and next steps.
                  </p>
                </div>
              </>
            )}
          ...
          <form className="chatComposer" onSubmit={submitProject}>
            <textarea
              placeholder="Example: I want to build a 16 x 20 covered deck..."
              value={message}
              onChange={(event) => {
