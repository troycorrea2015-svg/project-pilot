-- PROJECT PILOT 4.0 FRESH DATABASE INSTALL
-- ONLY use this on a brand-new Supabase project.
-- Existing Project Pilot databases should use RUN_THIS_IN_SUPABASE_4_0_UPGRADE.sql.
...
SELECT 'Project Pilot 4.0 fresh database install complete' AS result;
