-- PROJECT PILOT 4.2 CUMULATIVE UPGRADE
...
BEGIN
  IF to_regclass('public.permit_cases') IS NULL OR to_regclass('public.profiles') IS NULL OR to_regclass('public.projects') IS NULL THEN
    RAISE EXCEPTION 'This database is missing the Project Pilot base schema. Use RUN_THIS_IN_SUPABASE_FRESH_4_2.sql for a new database instead.';
  END IF;
END $$;
