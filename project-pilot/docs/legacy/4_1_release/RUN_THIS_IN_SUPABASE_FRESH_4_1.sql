-- PROJECT PILOT 4.1 FRESH DATABASE INSTALL
-- ONLY use this on a brand-new Supabase project.
-- Existing Project Pilot databases should use RUN_THIS_IN_SUPABASE_4_1_UPGRADE.sql.
...
SELECT 'Project Pilot 4.1 fresh database install complete' AS result;
