...
export const COVERAGE_SUMMARY = {
  region: "Delmarva Peninsula coverage",
...
export function resolveAuthority({ incorporatedPlace, countyName, stateName, zip }) {
  ...
  if (state === "Maryland") {
    ...
    if (!base) {
      return authorityWithConfidence(
        ...
        "low",
        "The address appears to be in Maryland, but the county is outside the nine-county Eastern Shore coverage area or could not be confirmed."
      );
    }
  ...
  return authorityWithConfidence(
    ...
    "low",
    "Project Pilot currently supports the Delmarva Peninsula: Delaware, Maryland's Eastern Shore, and Virginia's Eastern Shore."
  );
}
